      ...
      {isDialogOpen ? (
        <div className="destroy-dialog" role="presentation">
          ...
          <section aria-labelledby="destroy-dialog-title" aria-modal="true" className="destroy-dialog__panel" role="dialog">
            ...
            <p>
              This will destroy the current Lightsail OpenClaw instance, clear generated Second Brain project history for this account, reset onboarding, and log you out.
            </p>
